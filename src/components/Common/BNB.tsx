    ...
    <div className="absolute bottom-0 left-0 w-full rounded-t-[20px] bg-white shadow-[5px_1px_6px_0px_#D9D9D9]">
      <div className="absolute left-1/2 top-0 -translate-x-1/2 -translate-y-1/2">
        <Link href="/">
          ...
          >
            <Ggosunnae />
            <p className="mt-[2px] text-xs font-semibold leading-[18px] tracking-25">꼬순내</p>
          </animated.div>
        </Link>
        <Link href="/">
          <animated.div
          ...
          >
            <LookbookIcon />
            <p className="mt-[2px] text-xs font-semibold leading-[18px] tracking-25">룩북</p>
          </animated.div>
        </Link>
        <button
          type="button"
