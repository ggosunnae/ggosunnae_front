    ...
    <main className="bg-black">
      <div className="no-scrollbar h-[calc(100vh-100px)] overflow-y-scroll">
        <Link
          ...
          className="mt-10 flex items-center justify-between px-4 leading-[30px]"
        >
          <p className="text-xl font-semibold tracking-tight text-white">오늘 뭐 입지? #OOTD</p>
          <RightArrow width="24" height="24" />
        </Link>
        <div className="flex gap-3 px-4 py-[30px]">
          <Chips label="스트릿" />
          <Chips label="하이엔드" />
          <Chips label="코스프레" />
          <Chips label="시밀러룩" />
        ...
        <Link
          ...
          className="mt-[22px] flex items-center justify-between px-4 leading-[30px]"
        >
        ...
        <div className="flex gap-3 px-4 py-[22px]">
          <Chips label="XS~S" />
          <Chips label="M~L" />
          <Chips label="XL+" />
        </div>
        ...
        <Link
          ...
          className="mt-[30px] flex items-center justify-between px-4 leading-[30px]"
        >
